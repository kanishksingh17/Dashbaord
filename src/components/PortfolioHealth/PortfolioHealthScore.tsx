    ...
    return (
      <Card className="rounded-2xl hover:shadow-md transition-all">
        <CardHeader className="flex items-center justify-between pb-2">
          <div>
            <CardTitle className="text-sm text-gray-900">Portfolio Health Score</CardTitle>
            <p className="text-xs text-gray-500">AI-powered analysis of your portfolio strength</p>
          </div>
      ...
      <Card className="rounded-2xl hover:shadow-md transition-all">
        ...
        <CardContent className="pt-0">
          <div className="flex flex-col items-center justify-center h-32 text-gray-400">
            ...
            <Button variant="outline" size="sm" className="mt-2" onClick={onRecompute}>
              Get AI Insights
            </Button>
          </div>
        </CardContent>
  ...
  return (
    <Card className="rounded-2xl hover:shadow-md transition-all">
      <CardHeader className="flex items-center justify-between">
        <div>
          <CardTitle className="text-base text-gray-900">Portfolio Health Score</CardTitle>
          <p className="text-xs text-gray-500">AI-powered analysis of your portfolio strength</p>
        </div>
        <div className="flex gap-2">
      ...
      <CardContent className="pt-2">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            <h3 className={`text-3xl font-bold ${getScoreColor(health.overall)}`}>
              {health.overall}/100
            </h3>
        ...
        {health.recommendedImprovements.length > 0 && (
          <div className="mt-4 p-3 bg-blue-50 rounded-lg">
            <h4 className="text-sm font-medium text-blue-900 mb-2">Recommended Improvements</h4>
            <ul className="text-xs text-blue-700 space-y-1">
              {health.recommendedImprovements.slice(0, 3).map((improvement, index) => (
